...
namespace crud_list
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<credentials> data1 = new List<credentials>();
            int option;
            int adminoption;
            do
            {
                load_data(data, path);
                load_data1(data1, path1);
                Console.Clear();
                option = loginMenu();
        ...
        static void updatePricesOfProducts(List<credentials> data1)
        {
            int newPrices;
        ...
        static void removeProducts(List<credentials> data1)
        {
            int removeSize;
        ...
        static void viewAllProducts(List<credentials> data1)
        {
            Console.Clear();
            Console.WriteLine("");
            Console.WriteLine("--> PRODUCTS ");
        ...
        static void load_data1(List<credentials> data1, string path1)
        {
            string record;
        ...
        static void writeData(List <credentials> data, string path)
        {
            
            StreamWriter recordfile = new StreamWriter(path);
            for (int x = 0; x < data.Count; x++)
            {
                recordfile.WriteLine(data[x].userName + "," + data[x].password );
            }
            recordfile.Flush();
            recordfile.Close();
        ...
        static void writeData1(List<credentials> data1, string path1)
        {

            StreamWriter recordfile = new StreamWriter(path1);
            for (int x = 0; x < data1.Count; x++)
            {
                recordfile.WriteLine(data1[x].name + "," + data1[x].price);
            }
            recordfile.Flush();
            recordfile.Close();
